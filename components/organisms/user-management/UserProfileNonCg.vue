      ...
      <div class="profile-detail-container">
        ...
        <div class="input-box">
          <input-field
            ...
            :placeholder="
              $t('userManagement.input') +
              $t('userManagement.userProfile.email')
            "
        ...
        <div class="input-box">
          <password-generator
            ...
            :placeholder="
              $t('userManagement.input') +
              $t('userManagement.userProfile.password')
            "
            :error-message="error.password"
            :required="mode === 'create'"
            :tooltipMessage="$t('userManagement.error.invalidPassword')"
...
const validations = {
  ...
  validationGroupCreateScopeBranch: [
    'username',
    'firstName',
    'lastName',
    'userType',
  ...
  validationGroupEditScopeBranch: [
    'username',
    'firstName',
    'lastName',
    'userType',
...
export default class UserProfileNonCg extends Vue {
  ...
  checkBranch(): void {
    this.error.branch = !this.$v.branch.required
      ? this.$t('userManagement.select').toString() +
        this.$t('userManagement.userProfile.branch')
      : ''
  }
  ...
  checkPassword(): void {
    ...
    this.error.password = !this.$v.password.required
      ...
      : !this.$v.password.minLength || !this.$v.password.mustBe
      ...
      },
      {
        title:
          this.mode === 'create'
            ...
            : this.$t('userManagement.editNonCgUser').toString(),
        url: '/',
        active: true
      }
    ]
  ...
  onClickGen() {
    this.changePasswordMode = 'RESET'
  }

  async submit() {
    if (this.mode === 'create') {
      if (this.userScope == '4') {
        if (this.$v.validationGroupCreateScopeBranch.$invalid) {
          this.checkUsername()
          this.checkFirstName()
          this.checkLastName()
          this.checkUserType()
        ...
        if (this.$v.validationGroupCreate.$invalid) {
          this.checkUsername()
          this.checkFirstName()
          this.checkLastName()
          this.checkUserType()
